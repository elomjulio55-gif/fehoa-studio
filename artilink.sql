...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 09 juin 2026 à 10:54
...
CREATE TABLE `prestataire` (
  ...
  `noteMoyenne` decimal(11,0) NOT NULL,
...
--
ALTER TABLE `demande`
  ADD CONSTRAINT `demande_ibfk_1` FOREIGN KEY (`idClient`) REFERENCES `utilisateur` (`ID`),
  ADD CONSTRAINT `demande_ibfk_2` FOREIGN KEY (`idPrestataire`) REFERENCES `prestataire` (`ID`);
